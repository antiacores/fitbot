...
const GLOBAL_STYLES = `
  ...
  *, *::before, *::after { box-sizing: border-box; margin: 0; padding: 0; }
  ...
  .field input::placeholder { color: #2d4a58; }
...
export default function App() {
  const [pantalla, setPantalla] = useState("login"); // login | registro | chat
  const [usuario, setUsuario] = useState(null); // { username, nombre }
